...
# python run_evaluation.py --data_type LIGHTRAG_MIX --graph_type lightrag --lightrag_mode hybrid --ollama_url http://192.168.63.174:11434
...
# python run_evaluation.py --data_type LIGHTRAG_MIX --graph_type lightrag --lightrag_mode hybrid --plugin_simmerge --simmerge_threshold 0.95 --ollama_url http://192.168.63.174:11434
# python run_evaluation.py --data_type LIGHTRAG_MIX --graph_type lightrag --lightrag_mode hybrid --plugin_simmerge --simmerge_threshold 0.95 --simmerge_text_mode name_desc --ollama_url http://192.168.63.174:11434
# python run_evaluation.py --data_type LIGHTRAG_MIX --graph_type lightrag --lightrag_mode hybrid --plugin_simmerge --simmerge_threshold 0.9 --ollama_url http://192.168.63.174:11434
# python run_evaluation.py --data_type LIGHTRAG_MIX --graph_type lightrag --lightrag_mode hybrid --plugin_simmerge --simmerge_threshold 0.9 --simmerge_text_mode name_desc --ollama_url http://192.168.63.174:11434
